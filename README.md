[![Netlify Status](https://api.netlify.com/api/v1/badges/55d0e9f5-8e0d-422e-a3d0-38a79ecf2413/deploy-status)](https://app.netlify.com/sites/celadon-faloodeh-197304/deploys)
# Lancer Briefings

**[Live Demo](https://lancer.strugglecraft.net/)** (No Room for a Wallflower Spoilers)
